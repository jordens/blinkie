...
class PapilioProSDRAMSoC(SDRAMSoC):
...
class BlinkieSoC(PapilioProSDRAMSoC):
	csr_map = {
		"blinker":				16,
	}
	csr_map.update(PapilioProSDRAMSoC.csr_map)

	def __init__(self, platform):
		PapilioProSDRAMSoC.__init__(self, platform)
